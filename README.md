...
*   **Neu (Tooling):** Frontmatter mit `allowed-tools` (Read/Write/Edit/Grep/Glob/AskUserQuestion), damit der Skill optional auch direkt über Dateien laufen und bei Bedarf gezielt nachfragen kann statt nur über eingefügten Text zu arbeiten.
